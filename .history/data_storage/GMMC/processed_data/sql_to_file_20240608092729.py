...
try:
    ...
    print("cursor", cursor)
    tables = cursor.fetchall() #TODO - Why doesnt this fetch: to generalise.
    print(f"Tables in the database: {tables}")

    tables = [('GMMC-2020-M',), ('determinand',), ('location',),('sampling_data',)]
    print(f"MOD: Tables in the database: {tables}")
